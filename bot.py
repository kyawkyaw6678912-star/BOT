...
================================================================================
 ...
 Starlink (Ruijie) Voucher Scanner + Telegram Bot   |   Telegram @kyawzin114800
--------------------------------------------------------------------------------
...
BOT_TOKEN = "8180059053:AAFwN5pixufG8fa76kTWpS3H6UsGtUUgy2o"
ADMIN_IDS = [6779617599]

GITHUB_OWNER = "kyawkyaw6678912-star"
GITHUB_REPO = "BOT"
GITHUB_TOKEN = "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"
...
async def live_dashboard_updater(context: "ContextTypes.DEFAULT_TYPE", user_id: int):
    ...
    try:
        while not stop_event.is_set():
            ...
            text = (
                "⚡ Scanner Running ⚡\n"
                "Thank for using By Telegram @kyawzin114800\n"
                "━━━━━━━━━━━━━━━━━━\n"
                f"🎯 Tried: {state['tried']}\n"
                f"🔥 Hits: {state['hits']}\n"
    ...
    async def wrapper(update: Update, context: "ContextTypes.DEFAULT_TYPE", *args, **kwargs):
        ...
        if not user or user.id not in ADMIN_IDS:
            await update.effective_message.reply_text(
                ...
                "အလွန်အကျွံ အသုံးပြုရင် telegram @kyawzin114800ဆီ ရင်းပါ")
            return
...
def main():
    ...
    print("Thank for using By Telegram@kyawzin114800")
